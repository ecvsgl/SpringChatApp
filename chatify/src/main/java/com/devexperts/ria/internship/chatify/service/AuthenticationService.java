...
public class AuthenticationService {
    ...
    public String registerUser(UserRequest userRequest) {
        if (isInvalidRequest(userRequest)) {
        ...
        userRepository.save(
                new User(userRequest.getUsername(), passwordEncoder.encode(userRequest.getPassword()), authorities)
        );
    ...
    private boolean isInvalidRequest(UserRequest userRequest) {
